...
export const aiInvoiceModalStyles = {
  ...
  modal: "relative max-w-3xl w-full bg-white rounded-2xl shadow-2xl p-6 z-10 transform transition-all duration-300",
...
export const appShellStyles = {
  // Layout
  root: "min-h-screen bg-gradient-to-br from-gray-50 via-blue-50/20 to-indigo-50/10",
  ...
  logoImage: "h-14 w-14 object-contain drop-shadow-lg group-hover:drop-shadow-xl transition-all duration-300",
